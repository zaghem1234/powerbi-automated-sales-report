...
👉 We make an automation for this whole process that will use **Microsoft Power BI** and **Outlook integration**.  
...
👉 porcess is:  email received in outlook ---> comes in Power BI ---> cleaned & transformed ---> report updated with new data ---> report send to stakholder
---
